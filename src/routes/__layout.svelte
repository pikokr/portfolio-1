<script lang="ts">
  ...
  onMount(() => {
    setup().then(() => (ready = true))
  })
</script>

{#if !ready}
  <div out:fade class="flex w-screen h-screen fixed left-0 top-0 justify-center items-center">
    <svg
      aria-hidden="true"
...
<div bind:this={root} class="h-screen w-screen">
  <div>
    {#if ready}
